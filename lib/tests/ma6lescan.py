...
for i in range(numberlist):
	dut[0].advertising(serial=1,instance=i+1,advmode=enums.Advertisingmode.lowlatency.value,advpower=enums.Advertisingpower.highpower.value,connectable=enums.Connectable.connectable.value,timeout=0,datalength=251)
dut[0].startlescan(instance=1,filterid=1,filtertype=,filtervalue=scanmode=2,callbacktype=1,scanresulttype=0,reportdelay=0)
