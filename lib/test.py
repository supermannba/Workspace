...
class Basetest(object):
	...
	def advertising(deviceid,instance,UUID,advmode,advpower,connectable,timeout,dut1=Androiddevicebt):
	...
	def scanandconnect(deviceid,serial,deviceaddr,dut1=Androiddevicebt):
